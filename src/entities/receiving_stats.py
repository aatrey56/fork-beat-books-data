...
class ReceivingStats(Base):
    ...
    __table_args__ = (
        UniqueConstraint("player_name", "season", "tm", name="uq_receiving_stats_player_season_tm"),
    )
    ...
    tgt: Mapped[Optional[int]] = mapped_column(Integer)
    rec: Mapped[Optional[int]] = mapped_column(Integer)
    yds: Mapped[Optional[int]] = mapped_column(Integer)
    ypr: Mapped[Optional[Decimal]] = mapped_column(Numeric(5, 2))
    ...
    rpg: Mapped[Optional[Decimal]] = mapped_column(Numeric(6, 2))
    ypg: Mapped[Optional[Decimal]] = mapped_column(Numeric(6, 2))
    catch_pct: Mapped[Optional[Decimal]] = mapped_column(Numeric(5, 2))
    ypt: Mapped[Optional[Decimal]] = mapped_column(Numeric(5, 2))
