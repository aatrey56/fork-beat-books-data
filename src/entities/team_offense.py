...
class TeamOffense(Base):
    __tablename__ = "team_offense"
    __table_args__ = (
        UniqueConstraint("tm", "season", name="uq_team_offense_tm_season"),
    )
    ...
    opea: Mapped[Optional[Decimal]] = mapped_column(Numeric(8, 2))
