...
class OddsCreate(BaseModel):
    ...
    week: int = Field(..., ge=1, le=22, description="Week number (1-18 regular, 19-22 playoffs)")
    ...
    sportsbook: str = Field(..., max_length=64, description="Sportsbook name (e.g., DraftKings, FanDuel)")

    spread_home: Optional[Decimal] = Field(None, description="Point spread for home team (e.g., -7.5)")
    spread_away: Optional[Decimal] = Field(None, description="Point spread for away team (e.g., +7.5)")

    moneyline_home: Optional[int] = Field(None, description="Moneyline odds for home team (e.g., -150)")
    moneyline_away: Optional[int] = Field(None, description="Moneyline odds for away team (e.g., +130)")

    over_under: Optional[Decimal] = Field(None, description="Total points over/under line")
